...
@Stateless
@LocalBean
public class Used_Timeslot_Rate implements Used_Timeslot_Rate_Remote, Used_Timeslot_Rate_Local {

    /**
     * Default constructor. 
     */
    public Used_Timeslot_Rate() {
    ...
    public String ConsommationDay()
    {
    	...
    	WebTarget targetDay=client.target("http://localhost:54656/api/Used_Timeslot_Rate_Day");
	...
	public String Report_Description() {
		// TODO Auto-generated method stub
		String msg="Used Timeslot Rate per day: "+ConsommationDay()+"\n"+
				  "Used Timeslot Rate per Week: "+ConsommationWeek()+"\n"+
				  "Used Timeslot Rate per Month: "+ConsommationMonth()+"\n"+"\n";
		return  msg;
	}
